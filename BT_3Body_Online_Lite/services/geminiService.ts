...
- 다음 5항목을 배열로 출력. 이름(name)은 아래와 정확히 동일하게 작성.
  ...
  2) "어깨 / 골반 좌우 대칭" [정면 사진 기준]
     • Good(90~100): 양 어깨·골반 높이 차 0.5cm 미만  - **overallScore(3바디 코어 밸런스 점수):** 3바디 코어 밸런스 점수는 신체, 얼굴, 뇌, 마음(7코드) 4가지 요소를 모두 반영한 점수입니다. 시스템이 자동 계산하므로, summary 작성 시 이 점수가 "신체 측정뿐만 아니라 얼굴 노화도, 두뇌 인지 반응, 7코드 에너지 밸런스를 모두 종합한 3바디 코어 밸런스 점수"라는 점을 강조하세요.
